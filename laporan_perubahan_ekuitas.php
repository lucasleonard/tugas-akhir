  ...
  <section>
        ...
        <ul class="nav nav-pills nav-stacked nav-bracket">
          ...
          <li class="nav-parent nav-active active"><a href=""><i class="fa fa-file-text-o"></i> <span>Laporan</span></a>
            <ul class="children" style="display: block;">
              ...
              <li class="active"><a href="laporan_perubahan_ekuitas.php"><i class="fa fa-caret-right"></i> <span>Laporan Perubahan Ekuitas</span></a></li>
    ...
    <div class="mainpanel">
      ...
      <div class="pageheader">
        <h2><i class="fa fa-file-text-o"></i> Laporan Perubahan Ekuitas </h2>
      </div>
        ...
        <div class="row">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4 class="panel-title">Laporan Perubahan Ekuitas</h4>
            </div>
            <div class="panel-body">
              <div class="row p-t-50">
                <div class="col-sm-12">
                  <div class="m-b-20 table-responsive">
                    <table id="tableEkuitas" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>No.</th>
                          <th>No Akun</th>
                      ...
                      <tbody>
                        ...
                        $hitung = 1;
                        $index = 0;
                        while ($row = mysqli_fetch_object($laporanPerubahanEkuitas)) {
                          echo "<tr data-index='".$index."'>";
                          echo "<td>" . $hitung. "</td>";
                          echo "<td>" . $row->NoAkun . "</td>";
                          echo "<td>" . $row->NamaAkun . "</td>";
                          $saldoAkhir = $row->SaldoAkhir;
                          $totalModalPemilik += $saldoAkhir;
                          if($saldoAkhir > 0)
                          {
                        ...
                        if(!($row = mysqli_fetch_object($laporanPerubahanEkuitas))) {
              ...
              <div class="panel-body" id="formAwal">
                <div class="form-group">
                  <div class="col-sm-6 col-md-6">
                    <label class="col-sm-4 control-label" style="font-size: 18px; text-align: left;">Modal Pemilik saat ini : <?php echo number_format($totalModalPemilik); ?></label>
                  </div>
                </div>
                </div>
                <div class="form-group">
