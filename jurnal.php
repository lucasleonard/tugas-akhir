  ...
  <section>
    ...
    <div class="mainpanel">
      ...
      <div class="pageheader">
        <h2><i class="fa fa-file-text-o"></i> Laporan Jurnal </h2>
      </div>
        ...
        <div class="row">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4 class="panel-title">Laporan Jurnal</h4>
            </div>
                  ...
                  <div class="m-b-20 table-responsive">
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        $hitung = 1;
                        $index = 0;
                        while ($row = mysqli_fetch_object($laporanJurnal)) {
                          ...
                          if($row->Debet > 0)
                            echo "<td>" . number_format($row->Debet) . "</td>";
                          else
                            echo "<td>" . $row->Debet . "</td>";
                          if($row->Kredit > 0)
                            echo "<td>" . number_format($row->Kredit) . "</td>";
                          else
